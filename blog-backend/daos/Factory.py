...
class DaoFactory:
    ...
    def setup_db_connection(cls):
        ...
        cls.cnxpool = pooling.MySQLConnectionPool(pool_name='blogdbpool',
            pool_size=5,
            pool_reset_session=True,
            user=user, password=pwd, host=host, port=port, database=db, use_pure=True) 
